...
# Royal flush returnerar True om det är en Royal flush
def is_royal_flush(hand, board):
	...
	if right_color < 4:
		...
		if all_color:
			all_cards = (right_color, 1) in temp_list and (right_color, 13) in temp_list and (
				right_color, 12) in temp_list and (right_color, 11) in temp_list and (right_color, 10) in temp_list
...
def is_straight_flush(hand, board):
	...
	if right_color < 4:
		...
		if all_color:
			for x in range(1, 10):
				if (right_color, x) in temp_list and (right_color, x + 1) in temp_list and (
						right_color, x + 2) in temp_list and (right_color, x + 3) in temp_list and (
						right_color, x + 4) in temp_list:
					all_cards = True
